...
-- bundle (see infra/README.md → Connecting (TLS)). Pass the password via PGPASSWORD (a var
-- reference, so the literal never lands in shell history) — NOT interpolated into the URL,
-- where special chars break parsing and the value leaks into the process list:
--
